...
class CustomMattermost(models.Model):
    ...
    def sent_stock_webhooks(self):
        ...
        values = '{ "text": "['+str(purchase_order)+'] sudah dilakukan penerimaan dengan nomor RO / Picking : ' + str(picking_name)+' "}'
        ...
        #response if !200 then pop up error notification
            ...
            error_message = 'Error, pesan tidak terkirim' + str(response.status_code) + ''
